...
import com.ejemplo.rentacarros.service.UbicacionService;
...
/**
 * REST controller for managing {@link com.ejemplo.rentacarros.domain.Ubicacion}.
 */
@RestController
...
public class UbicacionResource {
    ...
    public ResponseEntity<UbicacionDTO> createUbicacion(@Valid @RequestBody UbicacionDTO ubicacionDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/ubicacions/" + ubicacionDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, ubicacionDTO.getId().toString()))
            .body(ubicacionDTO);
    }
    ...
    public ResponseEntity<UbicacionDTO> updateUbicacion(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, ubicacionDTO.getId().toString()))
            .body(ubicacionDTO);
    }
    ...
    public ResponseEntity<UbicacionDTO> partialUpdateUbicacion(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, ubicacionDTO.getId().toString())
        );
    }
