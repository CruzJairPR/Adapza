...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './ubicacion.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UBICACION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_UBICACION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_UBICACION actions', async () => {
      const arg = { id: 4727 };
    ...
    it('dispatches UPDATE_UBICACION actions', async () => {
      const arg = { id: 4727 };
    ...
    it('dispatches PARTIAL_UPDATE_UBICACION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_UBICACION actions', async () => {
      const arg = 42666;
