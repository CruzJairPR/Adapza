...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMBUSTIBLE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMBUSTIBLE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMBUSTIBLE actions', async () => {
      const arg = { id: 29144 };
    ...
    it('dispatches UPDATE_COMBUSTIBLE actions', async () => {
      const arg = { id: 29144 };
    ...
    it('dispatches PARTIAL_UPDATE_COMBUSTIBLE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMBUSTIBLE actions', async () => {
      const arg = 42666;
