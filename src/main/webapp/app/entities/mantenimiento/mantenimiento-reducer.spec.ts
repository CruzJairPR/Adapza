...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MANTENIMIENTO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MANTENIMIENTO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MANTENIMIENTO actions', async () => {
      const arg = { id: 12732 };
    ...
    it('dispatches UPDATE_MANTENIMIENTO actions', async () => {
      const arg = { id: 12732 };
    ...
    it('dispatches PARTIAL_UPDATE_MANTENIMIENTO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MANTENIMIENTO actions', async () => {
      const arg = 42666;
