...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './renta.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RENTA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RENTA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RENTA actions', async () => {
      const arg = { id: 12812 };
    ...
    it('dispatches UPDATE_RENTA actions', async () => {
      const arg = { id: 12812 };
    ...
    it('dispatches PARTIAL_UPDATE_RENTA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RENTA actions', async () => {
      const arg = 42666;
