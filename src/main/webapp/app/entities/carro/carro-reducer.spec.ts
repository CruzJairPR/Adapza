...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './carro.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARRO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CARRO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CARRO actions', async () => {
      const arg = { id: 15943 };
    ...
    it('dispatches UPDATE_CARRO actions', async () => {
      const arg = { id: 15943 };
    ...
    it('dispatches PARTIAL_UPDATE_CARRO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CARRO actions', async () => {
      const arg = 42666;
